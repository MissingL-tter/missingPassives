...
return {
	...
	{ var = "excludeCullingDPS", type = "check", label = "Exclude Culling DPS", tooltip = "Culling Strike is not calculated,\nand Culling DPS is excluded from Combined DPS and Full DPS" },
