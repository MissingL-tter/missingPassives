...
func TestCalcInitEnvAgainstReference(t *testing.T) {
	...
	variants := map[string]string{ // variant -> dump file
		...
		"ragevortex.treeonly":   "build_ragevortex.jsonl",
		"ragevortex.noskills":   "build_ragevortex.jsonl",
		"ragevortex.full":       "build_ragevortex.jsonl",
		"spectre1.treeonly":     "build_spectre1.jsonl",
		"spectre1.noskills":     "build_spectre1.jsonl",
		"spectre1.full":         "build_spectre1.jsonl",
		"spectre2.treeonly":     "build_spectre2.jsonl",
		"spectre2.noskills":     "build_spectre2.jsonl",
		"spectre2.full":         "build_spectre2.jsonl",
		"socketless.treeonly":   "build_socketless.jsonl",
		"socketless.noskills":   "build_socketless.jsonl",
		"socketless.full":       "build_socketless.jsonl",
		"socketamulet.treeonly": "build_socketamulet.jsonl",
		"socketamulet.noskills": "build_socketamulet.jsonl",
		"socketamulet.full":     "build_socketamulet.jsonl",
		"spectre3.treeonly":     "build_spectre3.jsonl",
		"spectre3.noskills":     "build_spectre3.jsonl",
		"spectre3.full":         "build_spectre3.jsonl",
	}
	checked := 0
