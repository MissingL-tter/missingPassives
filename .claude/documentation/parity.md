...
| trigger configs (`CalcTriggers.lua` configTable) | 54 of 80 |
| map-mod `apply` closures (`Data/ModMap.lua`) | 42 |
| guard panics across `calc/` | 18 |
