...
| gap | count |
|---|---|
| skill callbacks (`UnportedFn` → `calc/skillfuncs.go`) | 116 of 131 |
| trigger configs (`CalcTriggers.lua` configTable) | 76 of 80 |
| map-mod `apply` closures (`Data/ModMap.lua`) | 42 |
| guard panics across `calc/` | 24 |
